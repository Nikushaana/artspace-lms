...
export default function Page() {
  ...
  return (
    <div className="pb-[150px]">
      <div className="bg-[#010125] flex justify-center">
        <div className="max-w-[1540px] px-[12%] max-xl:px-[8%] max-md:px-[16px] max-sm:px-0 pb-[100px] pt-[130px] flex max-lg:flex-col gap-[30px] justify-between">
      ...
      <div className="flex justify-center">
        <div className="max-w-[1540px] w-full pt-[50px] px-[12%] max-xl:px-[8%] max-md:px-[16px] flex flex-col gap-y-[40px]">
          <div className="flex flex-col gap-y-[30px]">
            <h1 className="text-[25px]">პროგრამირება</h1>

            <div className="grid grid-cols-3 max-lg:grid-cols-2 max-sm:grid-cols-1 gap-[20px] gap-y-[40px]">
              <CourseCards />
              <CourseCards />
              <CourseCards />
              <CourseCards />
