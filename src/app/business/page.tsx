...
export default function page() {
  return (
    <div className="flex flex-col gap-y-[100px] max-sm:gap-y-[50px] pt-[130px] max-sm:pt-[100px] pb-[150px] px-[12%] max-xl:px-[8%] max-md:px-[16px] bg-[#010125f5] text-white">
      <div className="flex items-center justify-between gap-[20px] max-lg:flex-col">
        <div className="flex flex-col gap-y-[20px] w-[60%] max-lg:w-full max-lg:text-center">
          <h1 className="text-[25px] max-sm:text-[20px]">სუპერ შეთავაზებები ბიზნესისთვის</h1>
       ...
       <div className="flex flex-col gap-y-[20px]">
        <h1 className="text-[25px] max-sm:text-[20px] max-lg:text-center">ითანამშრომლეთ არტსფეისის აკადემიასთან</h1>
        <div
        ...
        >
          ...
          <p className="max-lg:text-[12px]">მიმდინარეობს თქვენი კომპანიის წარმატების ჩატვირთვის პროცესი</p>
        </div>
      </div>
      ...
      <div className="flex items-center justify-between gap-[30px] max-lg:flex-col">
        <div className="flex flex-col gap-y-[20px] w-[60%] max-lg:text-center max-lg:w-full">
          ...
          <p className="text-[15px]">
            ...
            სასწავლო კურსზე, რომლებიც ხელს შეუწყობს შენი თანამშრომლების კარიერულ
            განვითარებას.
          </p>
        </div>
     ...
     <div className="flex items-center justify-between gap-[30px] max-sm:gap-y-[20px] max-lg:flex-col">
        <div className="flex flex-col gap-y-[20px] w-[60%] max-lg:w-full max-lg:text-center">
          ...
          <p className="text-[15px]">
            ...
            გამოგვიგზავნო სასურველი სპეციალისტების სამუშაო აღწერილობები, ჩვენ კი
            არტსფეის აკადემიის წარმატებულ კურსდამთავრებულებს გავუწევთ
            რეკომენდაციას.
          </p>
        </div>
        <div className="flex flex-col gap-y-[20px] w-[40%] max-lg:w-full h-[280px] max-sm:h-[230px] items-end relative">
